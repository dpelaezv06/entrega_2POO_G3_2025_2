...
* pertenece el equipo de la maratón de programación
* @param lenguajeProgramacion Parámetro que define el lenguaje
...
if (estaLleno()) { /* Si el array está lleno, se genera la excepción
correspondiente */
...
EquipoMaratonProgramacion(nombre, universidad,
lenguaje);
